...
// это функция, которая передаётся как один из аргументов другой функции.
...
// 5)
//что такое Promise?
// код, который JS выполнит, но потом.
...
//происходящий во время, отличающееся от времени, в которое происходит что-то другое.
